...
When the Keras Tuner is used, you can essentially put in as many hyperparameter options as you think necessary, and the algortithm will run through all possible combinations until it finished/the best model has been found. 
